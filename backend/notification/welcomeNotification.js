...
const sendWelcomeEmail = async (email, fullname) => {
  const mailOptions = {
    ...
    to: email,
    subject: "Welcome to Secure Transit - Complete KYC & Unlock Exciting Offers!",
    html: `
                ...
                <div
                    ...
                    <div
                        ...
                        <h4 style="color: #fff; font-weight: normal; font-size: 16px; margin: 0; margin-bottom: 10px;">
                            Hi ${fullname},<br></h4>
                        <h2 style="color: #fff; font-size: 24px; font-weight: normal;margin: 0;">Welcome to Secure Transit!<br></h2>
                    </div>
                    <div style="padding: 25px 90px 65px;">
                        <p style="margin: 0px; line-height: 20px;">
                            <span class="size" style="font-size: 14px; margin: 0px; line-height: 20px;">We're very glad that you have chosen <b>Secure Transit</b> for your business.</span><br>
                        </p>
                        <div><br></div>
                        
                        <div><br></div>
                        <p style="margin: 0px 0px 30px; line-height: 20px;">
                            <span class="size" style="font-size: 14px; margin: 0px 0px 30px; line-height: 20px;">If you'd like to know more about <b>Secure Transit</b> or want to get in touch with us, get in touch with our customer support team.</span><br>
                        </p>
                        <p style="margin: 0px 0px 30px; line-height: 20px;">
                        ...
                        <p style="margin: 0px; line-height: 20px;">
                            <span class="size" style="font-size: 14px; margin: 0px; line-height: 20px;">Team Secure Transit.</span><br>
                        </p>
                    </div>
                </div>
            </td>
